...
export default function TimelinePage() {
  ...
  useEffect(() => {
    document.title = "Timeline | KeenKeeper";
  }, []);
          ...
          {timeline.length === 0 ? (
            <div className="bg-white border border-gray-200 rounded-xl p-20 text-center text-gray-400">
              ...
              <p className="text-sm mt-1">
                Go to a contact and tap Call, Text, or Video.
              </p>
            </div>
          ) : (
            filteredTimeline.map((entry) => {
              ...
              return (
                <div
                  key={entry.id}
                  className="flex items-center gap-4 px-5 py-4 my-2 bg-white border border-gray-200 hover:bg-gray-50 rounded-xl cursor-pointer"
                >
                  {/* Icon */}
                  <div
